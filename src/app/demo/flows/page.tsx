...
export default function DemoFlowsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-16 md:pb-0">
      {/* Demo header without auth context */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-12">
              <nav className="hidden md:flex space-x-4 h-full">
                <Link
                  href="/demo/overview"
                  className="px-3 py-2 text-sm rounded-lg bg-green-100 text-green-800 hover:bg-green-200 transition-colors"
                >
                  📊 概要
                </Link>
                <Link
                ...
                <Link
                  ...
                  className="px-3 py-2 text-sm rounded-lg bg-purple-100 text-purple-800 hover:bg-purple-200 transition-colors"
                >
                  🧩 UI
                </Link>
              </nav>
