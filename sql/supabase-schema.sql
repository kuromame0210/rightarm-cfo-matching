...
-- rightarm_rightarm_users テーブル（ユーザー基本情報）
CREATE TABLE IF NOT EXISTS rightarm_rightarm_users (
...
-- rightarm_rightarm_user_profiles テーブル（ユーザープロフィール詳細）
CREATE TABLE IF NOT EXISTS rightarm_rightarm_user_profiles (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID NOT NULL REFERENCES rightarm_rightarm_users(id) ON DELETE CASCADE,
...
-- rightarm_admin_rightarm_users テーブル（管理者ユーザー）
CREATE TABLE IF NOT EXISTS rightarm_admin_rightarm_users (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    email VARCHAR(255) UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS rightarm_audit_logs (
    ...
    admin_user_id UUID REFERENCES rightarm_admin_rightarm_users(id),
...
CREATE POLICY "Enable read access for all rightarm_users" ON rightarm_users FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_users" ON rightarm_users FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_users" ON rightarm_users FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_users" ON rightarm_users FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_user_profiles" ON rightarm_user_profiles FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_user_profiles" ON rightarm_user_profiles FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_user_profiles" ON rightarm_user_profiles FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_user_profiles" ON rightarm_user_profiles FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_companies" ON rightarm_companies FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_companies" ON rightarm_companies FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_companies" ON rightarm_companies FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_companies" ON rightarm_companies FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_cfos" ON rightarm_cfos FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_cfos" ON rightarm_cfos FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_cfos" ON rightarm_cfos FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_cfos" ON rightarm_cfos FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_cfo_skills" ON rightarm_cfo_skills FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_cfo_skills" ON rightarm_cfo_skills FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_cfo_skills" ON rightarm_cfo_skills FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_cfo_skills" ON rightarm_cfo_skills FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_company_challenges" ON rightarm_company_challenges FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_company_challenges" ON rightarm_company_challenges FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_company_challenges" ON rightarm_company_challenges FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_company_challenges" ON rightarm_company_challenges FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_interests" ON rightarm_interests FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_interests" ON rightarm_interests FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_interests" ON rightarm_interests FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_interests" ON rightarm_interests FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_scouts" ON rightarm_scouts FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_scouts" ON rightarm_scouts FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_scouts" ON rightarm_scouts FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_scouts" ON rightarm_scouts FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_contracts" ON rightarm_contracts FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_contracts" ON rightarm_contracts FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_contracts" ON rightarm_contracts FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_contracts" ON rightarm_contracts FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_invoices" ON rightarm_invoices FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_invoices" ON rightarm_invoices FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_invoices" ON rightarm_invoices FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_invoices" ON rightarm_invoices FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_conversations" ON rightarm_conversations FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_conversations" ON rightarm_conversations FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_conversations" ON rightarm_conversations FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_conversations" ON rightarm_conversations FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_messages" ON rightarm_messages FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_messages" ON rightarm_messages FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_messages" ON rightarm_messages FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_messages" ON rightarm_messages FOR DELETE USING (true);

CREATE POLICY "Enable read access for all rightarm_notifications" ON rightarm_notifications FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all rightarm_notifications" ON rightarm_notifications FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all rightarm_notifications" ON rightarm_notifications FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all rightarm_notifications" ON rightarm_notifications FOR DELETE USING (true);

-- タグテーブルは全ユーザーが読み取り可能
CREATE POLICY "Enable read access for all rightarm_skill_tags" ON rightarm_skill_tags FOR SELECT USING (true);
CREATE POLICY "Enable read access for all rightarm_challenge_tags" ON rightarm_challenge_tags FOR SELECT USING (true);
